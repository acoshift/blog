...
เท่าที่ลองโทรไปหา call center ทั้ง 3BB กับ AIS ยังไม่มีค่ายไหนที่มี fixed prefix
และจากการทดสอบ 3BB แค่เน็ตหลุด prefix ก็เปลี่ยนแล้ว ส่วน AIS หลายวันกว่า prefix เปลี่ยน
